              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TabBarView(
                      children: [
                        _buildusertable(screenSize),
                        _buildrequesttable(screenSize),
                      ],
                    ),
                  )
                ],
...
_buildusertable(screenSize) {
  return Container(
    ...
    child: SingleChildScrollView(
      child: Padding(
          padding: EdgeInsets.only(top: 15), child: datatable(screenSize)),
    ),
  );
}
...
DataRow recentFileDataRow(var data) {
  return DataRow(
    cells: [
      ...
      DataCell(Align(alignment: Alignment.center, child: _buildactions())),
    ],
  );
}
